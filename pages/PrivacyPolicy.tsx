    ...
    return (
        <div className="pt-32 pb-32 bg-khidmaat-bg dark:bg-slate-950 transition-colors relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-6 md:px-10">
                ...
                >
                    <span className="text-khidmaat-red font-black tracking-widest uppercase text-xs mb-6 block tracking-[0.5em]">{t('privacy.badge')}</span>
                    <h1 className="text-5xl md:text-7xl font-black text-slate-900 dark:text-white mb-6 tracking-tighter">{t('privacy.title')}</h1>
                    ...
                    <div className="space-y-16">
                        <section>
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">{t('privacy.sections.collection.title')}</h2>
                            </div>
                            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                                {t('privacy.sections.collection.desc')}
                            </p>
                        </section>
                        ...
                        <section>
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">{t('privacy.sections.usage.title')}</h2>
                            </div>
                            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                        ...
                        <section>
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">{t('privacy.sections.protection.title')}</h2>
                            </div>
                            <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
